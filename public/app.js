...
function renderScene() {
  ...
  if (current === 'headline') scene.innerHTML = header('01', 'El titular', 'Una alerta recorre la redacción. La noticia parece urgente, pero el informe original cuenta otra historia.') + `<article class="paper"><small class="eyebrow">ALERTA CLIMÁTICA · 23:21</small><div class="headline">CIENTÍFICOS CONFIRMAN QUE EL PLANETA PODRÍA SER INHABITABLE EN 10 AÑOS</div><p>Un informe modela un escenario hipotético de riesgo alto si no se reducen las emisiones. No presenta una predicción ni una fecha confirmada.</p><div class="source-line">FUENTE ORIGINAL: Informe de escenarios climáticos, sección 4.2</div><div class="clue"><b>Pregunta del archivo:</b> ¿Qué palabra hace que una posibilidad parezca una afirmación confirmada?</div>${inputPuzzle('headline','Escribe una palabra')}</article>`;
  if (current === 'photo') scene.innerHTML = header('02', 'La fotografía', 'Dos imágenes se usaron para ilustrar la misma noticia. Solo una coincide con la fecha, el lugar y el hecho descrito.') + `<div class="photo-grid"><div class="photo"><b>Imagen A</b><span class="hotspot" style="top:42%;left:47%" title="Fecha: 2017">2017</span><span class="hotspot" style="top:18%;right:12%" title="Puerto Norte">PUERTO NORTE</span></div><div class="photo two"><b>Imagen B</b><span class="hotspot" style="top:40%;left:45%" title="Fecha: 2024">2024</span><span class="hotspot" style="bottom:29%;right:14%" title="Barrio Central">BARRIO CENTRAL</span></div></div><div class="paper" style="margin-top:18px"><p><b>Noticia:</b> La evacuación preventiva se realizó en Barrio Central el 24 de julio de 2024.</p><div class="clue">La imagen correcta revela un código en su metadato: fecha (24) + imagen (17).</div>${inputPuzzle('photo','Código de cuatro cifras')}</div>`;
  if (current === 'social') scene.innerHTML = header('03', 'La red social', 'Miles de reacciones no prueban que algo sea cierto. Sigue el origen de cada publicación.') + `<div class="post"><b>@alerta_ahora</b><p>🔥 ¡INCREÍBLE! Nadie está hablando de esto.</p><small>12.4 mil compartidos · enlace sin autor · hace 2 h</small></div><div class="post"><b>@datos_sin_filtro</b><p>😱 Esto demuestra que los medios nos están mintiendo.</p><small>8.1 mil compartidos · captura recortada · hace 1 h</small></div><div class="post verified"><b>@observatorio_publico ✓</b><p>Los datos publicados muestran una variación mensual. Consulta la metodología completa.</p><small>Enlace al informe original · institución identificable · 08:14</small></div><div class="clue">La publicación útil enlaza al documento original. ¿Qué debes buscar antes de compartir?</div>${inputPuzzle('social','Una palabra')}</div>`;
